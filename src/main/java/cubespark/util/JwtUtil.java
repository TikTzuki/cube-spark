...
public class JwtUtil {
	...
	public Boolean validateToken(String token, UserDetails userDetails) {
		...
		System.out.println(headerFromToken);
		System.out.println(payloadFromToken);
		System.out.println(signFromToken);
		try {
		...
		return (username.equals(userDetails.getUsername()) && !isTokenExpired(token) && signature.contains(signFromToken));
	}
}
