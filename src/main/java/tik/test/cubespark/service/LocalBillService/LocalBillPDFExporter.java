...
public class LocalBillPDFExporter {

	public static ByteArrayInputStream export(List<LocalBillEntity> localBillEntity) {
		...
		try {
			...
			for (LocalBillEntity bill : localBillEntity) {

				PdfPCell cell;

				cell = new PdfPCell(new Phrase(bill.getId().toString(), elementFont));
				...
				cell = new PdfPCell(new Phrase(bill.getStatus(), elementFont));
